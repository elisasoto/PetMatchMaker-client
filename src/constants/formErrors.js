export const errorMessage = {
  ...
  agePattern: 'please enter a valid Pet Age (i.e 7 Years OR 3 Months)',
  ...
  maxWeightLenght: 'please enter a valid Weight in KG: (i.e: 8 OR 12)',
  phoneMinLenght: 'please enter a valid phone number',
  maxAgeLenght: 'please enter a valid age',
  maxHoursLenght: 'please enter a valid time',
  pharagraphMaxLength: 'Please write a shorter description',
  pharagraphMinLength: 'Please write a longer description'
};
